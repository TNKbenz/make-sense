...
export const DropDownMenuData: DropDownMenuNode[] = [
  {
    ...
    children: [
      ...
      {
        name: "Import Images with Defined Label",
        description: "Load more images with defined label",
        imageSrc: "ico/camera.png",
        imageAlt: "images",
        disabled: false,
        onClick: () =>
          store.dispatch(
            updateActivePopupType(PopupWindowType.IMPORT_IMAGES_FOLDER)
          ),
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        disabled: false,
        onClick: () =>
          window.open("https://github.com/TNKbenz/make-sense", "_blank"),
      },
    ],
  },
];
