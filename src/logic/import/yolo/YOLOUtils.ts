...
export class YOLOUtils {
  ...
  public static parseLabelsNamesFromListString(
    content: string | string[]
  ): LabelName[] {
    let labelNames: string[];

    if (typeof content === "string") {
      // If the content is a string, split it into an array of lines
      labelNames = content.split(/[\r\n]/).filter(Boolean);
    ...
    // Remove whitespace, check for uniqueness, and create LabelName objects
