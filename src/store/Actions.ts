export enum Action {
  ...
  UPDATE_MODELNAME = "@@UPDATE_MODELNAME",
  UPDATE_MODELTYPE = "@@UPDATE_MODELTYPE",
  UPDATE_COMPARE_MODELNAME = "@@UPDATE_COMPARE_MODELNAME",
  UPDATE_NOTICE_UPDATE = "@@UPDATE_NOTICE_UPDATE",
}
